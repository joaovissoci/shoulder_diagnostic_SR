...
#Loading packages
lapply(c("metafor","ggplot2","car" ,"mada","RCurl","gdata","meta",
		"foreign"), library, character.only=T)
...
webdata <- getURL("https://raw.githubusercontent.com/joaovissoci/shoulder_diagnostic_SR/master/shoulder_diagnostic_SR_metadata.csv")
...
webqualitydata <- getURL("https://raw.githubusercontent.com/joaovissoci/shoulder_diagnostic_SR/master/shoulder_diagnostic_SR_qualitydata.csv",ssl.verifypeer = FALSE)
